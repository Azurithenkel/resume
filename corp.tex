...
\begin{rSection}{Technical Competencies}
  \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
    Systems Programming             & C (5 years)                 \\
    Test Development and Automation & Python (7 years)            \\
    Version Control                 & Git and Mercurial (5 years) \\
    Data Analysus                   & ROOT (2 years)              \\
  \end{tabular}
...
\begin{rSection}{Other Skills}
  \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
    Spoken Languages   & Slovak, Czech, English (Bilingual), French (Intermediate) \\
    Mangement Software & JIRA, Bugzilla, Reviewboard (3 years)                     \\
...
\begin{rSection}{Hobbies}
  ...
  Literature, travelling, swing dancing \\
\end{rSection}
